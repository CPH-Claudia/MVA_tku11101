data <- read.table("C:/Users/user/Desktop/多變量11101/MVA-ToDo-master/QID-1118-MVAnpcahousi/bostonh.dat")
# transform data
xt       = data
xt[, 1]  = log(data[, 1])
xt[, 2]  = data[, 2]/10
...
n1  = nrow(data)
n2  = ncol(data)
x   = (data - matrix(mean(as.matrix(data)), n1, n2, byrow = T))/matrix(sqrt((n1 - 1) * apply(data, 2, var)/n1), n1, n2, byrow = T)  # standardizes the data
